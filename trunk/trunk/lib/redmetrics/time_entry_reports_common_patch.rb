...
Dispatcher.to_prepare do
  TimeEntryReportsController.send(:include, Redmetrics::TimeEntryReportsCommonPatch) if File.exists?("#{RAILS_ROOT}/app/controllers/time_entry_reports_controller.rb")
  TimelogController.send(:include, Redmetrics::TimeEntryReportsCommonPatch) if File.exists?("#{RAILS_ROOT}/app/controllers/timelog_controller.rb")
end
