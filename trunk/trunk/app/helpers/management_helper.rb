module ManagementHelper
  def link_to_metrics(project)
    ...
    elsif !project.module_enabled?(:redmetricsplugin)
      l('redmetrics.redmetrics_module_not_enabled')
    elsif !project.report_tracker?
      l('redmetrics.redmetrics_report_tracker_not_available')
    else
      l('redmetrics.redmetrics_no_reports')
    end
  end
